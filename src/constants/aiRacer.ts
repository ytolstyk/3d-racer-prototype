...
export const DIFFICULTY_CONFIG: Record<Difficulty, DifficultyParams> = {
  easy:   { skillRange: [0.68, 0.75], steeringNoise: 0.18, reactionDelay: 0.10, brakeSensitivity: 0.28, nextWaypointDistance: 5.0 },
  medium: { skillRange: [0.82, 0.90], steeringNoise: 0.09, reactionDelay: 0.07, brakeSensitivity: 0.38, nextWaypointDistance: 4.0 },
  hard:   { skillRange: [0.94, 1.00], steeringNoise: 0.03, reactionDelay: 0.02, brakeSensitivity: 0.48, nextWaypointDistance: 3.0 },
} as const;
